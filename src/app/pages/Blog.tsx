...
import type { BlogPost } from "@/app/api/types";
  ...
  if (loading) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-[#5A7A8A]">
        ...
        <p className="font-sans text-sm font-semibold">Loading health & wellness articles...</p>
      </div>
    );
  }
    ...
    <>
      ...
      <section className="section-py-sm section-white">
        <div className="site-container">
          {!featured ? (
            <div className="text-center py-12 text-[#5A7A8A]">
              <p className="font-sans">No articles published yet. Check back soon!</p>
            </div>
          ) : (
            <>
